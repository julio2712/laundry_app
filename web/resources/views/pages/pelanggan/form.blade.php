...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-6"><h1>Data Pelanggan</h1></div>
                <div class="col-6">
                ...
                <form action={{ isset($data)
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            name="nama_pelanggan" value={{ (isset($data)?$data->nama:old("nama_pelanggan")) }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" 
                        class="form-control @error("email") is-invalid @enderror" name="email" value={{ (isset($data)?$data->email:old("email")) }}>
                        @error("email")
                        <div class="invalid-feedback">
                           {{$message}}
                        </div>
